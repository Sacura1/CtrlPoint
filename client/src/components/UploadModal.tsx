      ...
      <div className="w-full max-w-md animate-scale-in"
        ...
        <div className="p-6">
          <div
            ...
            style={{
              border: `2px dashed ${dragging ? 'rgba(124,58,237,0.6)' : 'rgba(255,255,255,0.1)'}`,
            ...
            {uploading ? (
              <>
                <svg className="animate-spin mb-3" width="28" height="28" viewBox="0 0 28 28" fill="none">
                  <circle cx="14" cy="14" r="11" stroke="rgba(124,58,237,0.2)" strokeWidth="3"/>
                  <path d="M25 14a11 11 0 00-11-11" stroke="#7c3aed" strokeWidth="3" strokeLinecap="round"/>
                </svg>
              ...
              <>
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-4"
                  ...
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                    <path d="M11 14V4M7 8l4-4 4 4" stroke="#a78bfa" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M3 16v1a2 2 0 002 2h12a2 2 0 002-2v-1" stroke="#a78bfa" strokeWidth="1.8" strokeLinecap="round"/>
                  </svg>
                </div>
