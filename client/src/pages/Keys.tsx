    ...
    <div className="min-h-dvh" style={{ background: '#05050d' }}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-[30%] w-[500px] h-[300px] rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(124,58,237,0.15) 0%, transparent 70%)', filter: 'blur(100px)' }} />
      </div>

      <main className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-10 animate-fade-in">

        <div className="mb-8">
          <h1 className="text-2xl font-bold" style={{ color: '#f0f0ff' }}>API Keys</h1>
          ...
          <div className="mt-3 flex items-start gap-2 px-3 py-2.5 rounded-xl"
            ...
            <svg width="13" height="13" viewBox="0 0 14 14" fill="none" className="flex-shrink-0 mt-0.5">
              <path d="M5.5 7.5l1.5 1.5 2.5-3" stroke="#34d399" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2.5 mb-0.5">
                        <span className="text-base font-bold" style={{ color: '#f0f0ff' }}>{label}</span>
                        {hasSaved && (
                  ...
                  {hasSaved ? (
                    <div>
                      <div className="px-3.5 py-2.5 rounded-xl text-sm font-mono"
                        style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: '#4a4a6a' }}>
                        ••••••••••••••••••••••••••••••
                      </div>
